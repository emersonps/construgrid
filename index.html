...
<head>
  <meta charset="UTF-8">
  <title>Construgrid - Manaus - AM</title>
  <meta name="description" content="Compre a sua bicicleta personalizada na Bikcraft. Possuímos modelos Passeio, Retrô e Esporte">
  <meta property="og:type" content="website" />
  <meta property="og:title" content="Construgrid - Manaus - AM" />
...
<body>
  ...
  <header class="header">
    <div class="container">
      <a href="index.html" class="grid-4">
        <img src="img/construgrid/logo_horizon.svg" alt="Bikcraft">
      </a>
  ...
  <section class="introducao">
    <div class="container">
      <h1 data-anime="400" class="fadeInDown">Lorem Ipsum</h1>
  ...
  <section class="portfolio fadeInDown" data-anime="2000">
    <div class="container">
      ...
      <ul class="portfolio_lista">
        <li class="grid-8"><img src="img/construgrid/portfolio/portfolio1.jpg" alt="Bicicleta Retrô"></li>
        <li class="grid-8"><img src="img/construgrid/portfolio/portfolio3.jpg" alt="Bicicleta Passeio"></li>
        <li class="grid-16"><img src="img/construgrid/portfolio/portfolio4.jpg" alt="Bicicleta Esporte"></li>
      </ul>
      <div class="call">
  ...
  <section class="qualidade container fadeInDown" data-anime="2400">
    ...
    <img src="img/construgrid/logo.png" alt="Bikcraft" height="120px">
    ...
    <div class="footer">
      <div class="container">
        ...
        <div class="grid-4 footer_contato">
          ...
          <ul>
            <li>- (99) 9999-9999</li>
            <li>- contato@construgrid.com.br</li>
            <li>- Cidade - ES</li>
          </ul>
        </div>
